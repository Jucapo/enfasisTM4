                ...
                <section class="sidebar">
                    ...
                    <i class="fa fa-angle-left pull-right"></i>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="teorico.html"><i class="fa fa-circle-o"></i> Teorico</a></li>
                                <li><a href="practico.html"><i class="fa fa-circle-o"></i> Practico</a></li>
                                <li><a href="ejercicios.html"><i class="fa fa-circle-o"></i> Ejercicios</a></li>
                                <li><a href="documentales.html"><i class="fa fa-circle-o"></i> Documentales</a></li>
                                <li><a href="biografias.html"><i class="fa fa-circle-o"></i> Biografias</a></li>
                            </ul>
                        </li>
                         ...
                         <div class="col-md-9">
                            ...
                            <div>
                                ...
                                <div>                                       
                                    ...
                                    width="100%" style="height: auto;" controls autoplay>
                                </div>			
                                <!-- Boton pausar -->
                                <!-- <div id="buttonbar">
