                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_practico_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_1_practico; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_practico_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_2_practico; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_practico_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_3_practico; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_practico_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_4_practico; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_ejercicios_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_1_ejercicios; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_ejercicios_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_2_ejercicios; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_ejercicios_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_3_ejercicios; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_ejercicios_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_4_ejercicios; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_documentales_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_1_documentales; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_documentales_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_2_documentales; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_documentales_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_3_documentales; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_documentales_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_4_documentales; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_biografias_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_1_biografias; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_biografias_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_2_biografias; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_biografias_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_3_biografias; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
                                ...
                                <div class="col-md-3" style="font-size: 150%;" id="div_biografias_1">
                                    ...
                                    <a href="video.php?idVideo=<?php echo $idVideo_4_biografias; ?>" id="btn_play_video_rec1" type="button" class="btn bg-orange btn-flat margin"
                                       style="text-align: left;">Play
                                        <i class="fa fa-play"></i>
